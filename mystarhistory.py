...
def generate_svg(repo, dates, output, color, title, width=800, height=533, dark=False):
    ...
    svg_parts = [
        ...
        f'  <a href="https://github.com/carsteneu/mystarhistory" target="_blank" rel="noopener"><text x="{w - pad_r - 2}" y="{h - 6}" font-size="11" font-family="Handlee, cursive" fill="{FG}" fill-opacity="0.7" text-anchor="end">Made with carsteneu/mystarhistory</text></a>',
        '</svg>'
    ]
